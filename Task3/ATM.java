...
class Account 
{
    ...
    public void logIn() 
    {
        ...
        while (exit) 
        {
            ...
            {
                exit = false;
                System.out.println("Hello, " + this.getName(check_userId)+" ..");
            }
        }
    ...
    public void withdraw() 
    {
        ...
        if (details_balance.get(check_userId) != null && amount <= details_balance.get(check_userId)) 
        {
            ...
            String his = amount + "   has withdrawn from your acccount\n";
    ...
    public void deposit() 
    {
        ...
        int amount = sc.nextInt();
        String his = amount + "   has deposited to your acccount..\n";
    ...
    public void transfer()
    {
        ...
        if (transferAmount <= details_balance.get(check_userId) && details_balance.get(check_userId) != null) 
        {
            ...
            String his = transferAmount + "  has transferred from your acccount..\n";
